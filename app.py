...
if CHATBOT_AVAILABLE:
    chatbot_service = create_chatbot_service(ml_service)
else:
    ...
    try:
        ...
        <body style="font-family: Arial; text-align: center; padding: 50px;">
            ...
            <div style="margin: 20px;">
                ...
                <a href="/chat" style="margin: 10px; padding: 10px 20px; background: #17a2b8; color: white; text-decoration: none; border-radius: 5px;">AI Assistant</a>
            </div>
        </body>
        </html>
        """
...
def chat_api():
    ...
    try:
        ...
        bot_response = chatbot_service.process_message(user_message)
...
def system_info():
    ...
    return jsonify({
        "available_models": {
            ...
            "chatbot_assistant": CHATBOT_AVAILABLE
        },
        "data_statistics": {
        ...
        "features": {
            "roi_prediction": "ML-powered ROI calculations",
            "investment_analysis": "Comprehensive financial analysis",
            "market_comparison": "Side-by-side locality comparison",
            "heat_visualization": "Interactive ROI heat maps",
            "ai_assistant": "Intelligent chatbot for real estate queries"
        }
    })
...
if __name__ == "__main__":
    ...
    print(f"🤖 AI Chatbot: {'Available' if CHATBOT_AVAILABLE else 'Not Available'}")
    print(f"📊 Localities Loaded: {len(ml_service.data.get('localities', []))}")
    print("=" * 60)
    print("🌐 Server starting on http://localhost:5001")
    print("🔍 Health check: http://localhost:5001/health")
    print("📊 System info: http://localhost:5001/api/system-info")
    print("🤖 AI Assistant: http://localhost:5001/chat")
    print("🗺️ Heat Map: http://localhost:5001/roi-heatmap")
    print("=" * 60)
